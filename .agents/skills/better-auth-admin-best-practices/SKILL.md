...
description: Provides administrative capabilities for managing users, roles, sessions, and permissions in Better Auth. Includes APIs for listing users, updating user data, assigning roles, banning/unbanning users, impersonation, session control, and a flexible role-based access control system with customizable permissions.
---
